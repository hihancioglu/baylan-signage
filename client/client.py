...
def run_state_cycle():
    ...
    # üretip PLAYING -> RETURNING tetikleyebiliyor (özellikle widget veya active_item
    # kısa süreli okunamaz olduğunda). PLAYING durumunda low-idle tek başına yeterli
    # olmasın; en azından düşüş-temelli sinyal de doğrulanmış olsun.
    if current_state == ClientState.PLAYING and low_idle_confirmed and not activity_drop_confirmed:
